    ...
    <div className="flex gap-2 ml-2">
      <button
        ...
        className={`p-1.5 rounded-full transition-colors ${
          isCurrent ? "bg-green-600 hover:bg-green-700" : "bg-gray-600 hover:bg-gray-700"
        }`}
      ...
      <button
        onClick={handleReset}
        className={`p-1.5 rounded-full transition-colors ${
          isCurrent ? "bg-red-600 hover:bg-red-700" : "bg-gray-600 opacity-50 cursor-not-allowed"
        }`}
        disabled={!isCurrent}
        title="Reset"
      >
